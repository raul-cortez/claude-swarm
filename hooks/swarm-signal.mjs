...
const selfRestartNote = (absPath) => {
  ...
  return [
    ...
    'Можно сменить и модель: добавь "model" — fable, opus, sonnet или haiku. Обсудили задачу на',
    'дорогой, дальше механическая работа — поднимись на дешёвой, разговор и эстафета те же.',
  ].join('\n');
};
