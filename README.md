...
<p align="center">
  <!-- Ссылки обновляет scripts/release.mjs, вместе с блоком DL в разделе «Установка».
       ...
       которой уже нет. -->
<!--DLTOP-->
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.43.0/swarm-0.43.0-arm64.dmg"><b>⬇&nbsp;&nbsp;Скачать для macOS</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.43.0/swarm-0.43.0-x64.exe"><b>⬇&nbsp;&nbsp;Скачать для Windows</b></a>
  <br>
  <sub>v0.43.0 · Apple Silicon · <a href="#установка">macOS: один шаг после скачивания</a></sub>
  <!--/DLTOP-->
</p>
...
<!--DL-->
**Последняя версия: 0.43.0** · [все релизы](https://github.com/raul-cortez/claude-swarm/releases)

- **macOS** (Apple Silicon): [`swarm-0.43.0-arm64.dmg`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.43.0/swarm-0.43.0-arm64.dmg)
- **Windows**: [`swarm-0.43.0-x64.exe`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.43.0/swarm-0.43.0-x64.exe) — собирается в CI после тега
<!--/DL-->
...
**Всем сразу.** Значок «где я» в нижней панели открывает список из трёх положений; выберите **«меня нет»**, и ночной режим включится у всех вкладок разом. Вся нижняя панель станет синей: это видно от двери, и нужно это прежде всего при возвращении, когда приложение всё ещё считает, что вас нет.
...
Когда ночных вкладок не осталось — вы сняли «меня нет» или забрали последнюю себе, — в панели появляется **отчёт**.
