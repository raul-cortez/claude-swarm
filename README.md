...
<p align="center">
  <!-- Ссылки обновляет scripts/release.mjs, вместе с блоком DL в разделе «Установка».
       ...
       которой уже нет. -->
<!--DLTOP-->
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.65.0/swarm-0.65.0-arm64.dmg"><b>⬇&nbsp;&nbsp;Скачать для macOS</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.65.0/swarm-0.65.0-x64.exe"><b>⬇&nbsp;&nbsp;Скачать для Windows</b></a>
  <br>
  <sub>v0.65.0 · Apple Silicon · <a href="#установка">macOS: один шаг после скачивания</a></sub>
  <!--/DLTOP-->
</p>
...
<!--DL-->
**Последняя версия: 0.65.0** · [все релизы](https://github.com/raul-cortez/claude-swarm/releases)

- **macOS** (Apple Silicon): [`swarm-0.65.0-arm64.dmg`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.65.0/swarm-0.65.0-arm64.dmg)
- **Windows**: [`swarm-0.65.0-x64.exe`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.65.0/swarm-0.65.0-x64.exe) — собирается в CI после тега
<!--/DL-->
