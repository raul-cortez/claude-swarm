...
**Чего ночной режим не даёт.** Запросы разрешения Swarm за вас не одобряет: там нужно выбрать вариант в диалоге, а молча соглашаться на чужие команды — не то, за что стоит платить спокойным сном. Такая вкладка стоит до вашего возвращения — сколько она простояла и на чём, видно на её экране.
...
Значит включён общий ночной режим. В панели про это висит напоминание, клик по нему возвращает вас. Отдельные вкладки после этого продолжат сами — те, которым вы отдали задачу правым кликом.
