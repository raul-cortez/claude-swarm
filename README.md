...
<p align="center">
  <!-- Ссылки обновляет scripts/release.mjs, вместе с блоком DL в разделе «Установка».
       ...
       которой уже нет. -->
<!--DLTOP-->
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.63.1/swarm-0.63.1-arm64.dmg"><b>⬇&nbsp;&nbsp;Скачать для macOS</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.63.1/swarm-0.63.1-x64.exe"><b>⬇&nbsp;&nbsp;Скачать для Windows</b></a>
  <br>
  <sub>v0.63.1 · Apple Silicon · <a href="#установка">macOS: один шаг после скачивания</a></sub>
  <!--/DLTOP-->
</p>
...
<!--DL-->
**Последняя версия: 0.63.1** · [все релизы](https://github.com/raul-cortez/claude-swarm/releases)

- **macOS** (Apple Silicon): [`swarm-0.63.1-arm64.dmg`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.63.1/swarm-0.63.1-arm64.dmg)
- **Windows**: [`swarm-0.63.1-x64.exe`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.63.1/swarm-0.63.1-x64.exe) — собирается в CI после тега
<!--/DL-->
...
Полоска контекста отвечает на вопрос «кого пора сжимать». Полную картину показывает команда `/usage` в Telegram: все вкладки, самые полные сверху, плюс окна подписки на 5 часов и на неделю со временем сброса. Расход самой подписки виден и без телефона — в нижней панели, справа: оба окна, 5 часов и неделя, и время обновления лимитов, когда запас поджал. Клик по пилюле разворачивает список всех подписок с точным временем сброса словами — «через 2 часа 15 минут» или «завтра в 09:30», а не только часами на пилюле.
...
**Дайджест вкладки.** Открыв вкладку, вы не всегда хотите прокручивать весь ход, чтобы понять, чем агент занят прямо сейчас. Дайджест — пара строк над терминалом, которые пишет сам агент: не статус в одно слово, а короткая сводка своими словами. Выключено по умолчанию — включается галкой «Показывать дайджест вкладки» в Настройки → Общее.

<p align="center"><img src="docs/img/26-digest.png" width="900" alt="Дайджест вкладки над терминалом"></p>
...
**Свой терминал рядом.** Кнопка **терминал** (или ⌘J) открывает ещё одну панель — обычную оболочку, не привязанную ни к одному агенту: погонять тесты, посмотреть логи, дёрнуть git руками, не забирая фокус у вкладки и не мешая агенту печатать. У панели своя мини-полоска вкладок со своим плюсом, её можно перевесить снизу вбок и свернуть кнопкой в шапке — шеллы внутри при этом не гибнут, панель просто прячется до следующего ⌘J.

<p align="center"><img src="docs/img/27-dock-panel.png" width="900" alt="Пристыковываемая панель терминала снизу, с двумя вкладками шелла"></p>
...
<p align="center"><img src="docs/img/25-settings-subs.png" width="900" alt="Настройки → Подписки: карточки с именами и предпросмотром панели"></p>
