...
Кнопка **☰ команды** открывает список: встроенные команды по группам плюс найденные в проекте (`.claude/commands`, `.claude/skills`) и ваши глобальные. Выбрать из списка быстрее, чем вспоминать точное имя.
