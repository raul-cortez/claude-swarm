...
<p align="center">
  <!-- Ссылки обновляет scripts/release.mjs, вместе с блоком DL в разделе «Установка».
       ...
       которой уже нет. -->
  <!--DLTOP-->
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.32.0/swarm-0.32.0-arm64.dmg"><b>⬇&nbsp;&nbsp;Скачать для macOS</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/raul-cortez/claude-swarm/releases/download/v0.32.0/swarm-0.32.0-x64.exe"><b>⬇&nbsp;&nbsp;Скачать для Windows</b></a>
  <br>
  <sub>v0.32.0 · Apple Silicon · <a href="#установка">macOS: один шаг после скачивания</a></sub>
  <!--/DLTOP-->
</p>
...
<!--DL-->
**Последняя версия: 0.32.0** · [все релизы](https://github.com/raul-cortez/claude-swarm/releases)

- **macOS** (Apple Silicon): [`swarm-0.32.0-arm64.dmg`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.32.0/swarm-0.32.0-arm64.dmg)
- **Windows**: [`swarm-0.32.0-x64.exe`](https://github.com/raul-cortez/claude-swarm/releases/download/v0.32.0/swarm-0.32.0-x64.exe) — собирается в CI после тега
<!--/DL-->
...
**Своя строка статуса Клода или наша.** По умолчанию Swarm ставит вкладкам свою — из неё берутся полоска контекста и цифры в `/usage`. Если в вашей строке есть что-то важное, снимите галочку: ваша останется как есть, но полоска и расход пропадут, других источников у них нет.
...
<details>
<summary>Во вкладках чужая строка статуса Клода вместо моей</summary>

<br>

По умолчанию Swarm ставит вкладке свою строку — из неё берутся полоска контекста и ответ на `/usage`. Снимите галочку **«Своя строка статуса Swarm»** в «Настройки → Запуск», и новые вкладки пойдут с вашей. Полоска и `/usage` при этом замолчат.
