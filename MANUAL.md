...
правило. Переспросил о том же второй раз — значит вопрос настоящий, вкладка спокойно стоит до
утра.
...
**Вкладка простаивает.** Бывает третий случай, не похожий ни на вопрос, ни на «сделал»:
«закончил груминг, скажи когда приступать». Через две минуты простоя сворм спрашивает такую
вкладку сам: работа кончилась или ты на пороге следующей фазы? Агент выбирает одно из трёх —
всё сделано, продолжаю сам (и говорит, что начал), нужно ваше слово. За ночь одна вкладка
может так продолжить не больше трёх раз, дальше ждёт вас.
