...
**Одной вкладке.** Наведите на её карточку и нажмите **полумесяц** — он лежит в капсуле в
правом верхнем углу, рядом с крестиком, и остаётся горящим, пока вкладка ночная (крестик в
этом случае прячется до наведения: тянувшийся к луне не должен закрыть вкладку). Карточка целиком
...
**Всем сразу.** В нижней панели, рядом с шестерёнкой, стоит **луна**. Клик открывает список из
двух пунктов: «отдать все вкладки» и «забрать все себе» (второй спрашивает подтверждение —
вкладки бросят работу и встанут ждать вас). Луна на месте всегда: это единственная дверь к
«отдать все разом». Когда отданы все, вся нижняя панель становится синей — это видно от двери, и нужно это, когда вы
