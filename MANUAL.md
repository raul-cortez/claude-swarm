...
**Утро.** Снимите ночь тем же значком — и в панели появится «утро». Клик открывает список дел,
отсортированный не по времени, а по тому, что нужно от вас:

- **ждут вас** — вопрос целиком и сколько вкладка стоит; клик по строке уводит в саму вкладку;
- **стоят на разрешении** — что просят и сколько потеряно;
- **лимиты** — кто стоял и разбудили ли;
- **решено без вас** — развилка дословно, с вариантами, из которых агент выбирал. Это очередь
  на ревью и главная причина, по которой сводку стоит читать;
- **продолжили сами** — кто закрыл этап и пошёл дальше;
- дальше тихие: закончили и молчат, умерли.

<!-- ФОТО · docs/img/21-night-morning.png · окно «Утро» со списком групп. -->

Вкладки, о которых сводке есть что сказать, помечены в списке синей точкой — по ней видно, с
