...
Тем же способом решается третий случай — **запущена фоновая задача**. Агент отправил
долгий замер или сборку, ход закрыл, а вернётся к вам сам, когда та досчитает: отвечать
нечего, но и работу такой вкладке давать рано. Раньше она выглядела свободной (зелёной),
теперь агент говорит об этом словом: «Сейчас от тебя: ничего, **жду** замер стенда» —
и вкладка остаётся оранжевой, «работает в фоне». Разница со «жди результата» в лице
глагола: **жду** — ждёт агент, работа идёт; **жди** — ждёте вы, значит он закончил.
В телеграм такой ход уезжает с часиками ⏳ вместо галочки, чтобы с телефона было видно:
это ещё не конец, отвечать не нужно. Проверить, как приложение поймёт вашу фразу, можно
там же в настройках — под полем сразу написано «позовёт», «работает в фоне» или «готов».
