...
Агент может умереть, не забрав вкладку с собой: `claude` кончился, а оболочка осталась стоять с
приглашением. Со стороны это выглядит спокойно — вкладка ничем не отличается от той, которой
просто не давали задачи, — и работа, брошенная посреди ночи, находится только утром и наугад.

Swarm такую вкладку узнаёт и **красит серым с подписью, отчего агента не стало**: «агент убит:
killed», если так сказала оболочка, или «агент исчез на ходу», если она промолчала, а ход
оборвался на середине. Подпись держится до тех пор, пока во вкладке снова не заведётся агент.

Разговор при этом почти всегда цел: Клод пишет стенограмму по ходу дела, и в ней остаётся всё,
что было сказано до последней секунды. Поднять его — **правый клик по карточке → «Поднять
упавший разговор»**: во вкладку уедет та же строка запуска, которой её открывали, с `--resume`
прежнего разговора. Пункт серый, если поднимать нечего — во вкладке уже работает агент, или её
запускали не Клодом.

Заодно вкладка отмывается: упавший агент оставляет терминал в мышином режиме, и без уборки
каждое движение мыши сыпало бы в приглашение оболочки строки вида `35;57;4M`.
