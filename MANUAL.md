...
Сколько израсходовано, видно в **нижней панели** — справа, рядом с луной. Одно число: то окно,
которое ближе к концу (пятичасовое или недельное), и оно молчит тихим серым, пока запас есть.
Израсходовано больше 75% — пилюля обводится янтарным и рядом появляется, через сколько лимиты
обновятся; больше 90% — красным. Клик открывает список: обе подписки, оба окна и точное время
